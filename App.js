...
const HomeScreen = ({ navigation }) => (
  <View style={styles.container}>
    ...
    {/* FIXED: Removed nested TouchableOpacity error */}
  ...
  <View style={styles.container}>
    ...
    {['Batting', 'Bowling', 'Fielding', 'Fitness'].map((cat) => (
      ...
      <TouchableOpacity 
        ...
        style={styles.btn} 
        onPress={() => {
          if (cat === 'Batting') navigation.navigate('BattingLog', { category: cat, date: route.params.date });
          else if (cat === 'Bowling') navigation.navigate('BowlingLog', { category: cat, date: route.params.date });
...
const BattingLogScreen = ({ route, navigation }) => {
  ...
  const handleSave = async () => {
    ...
    if (promises.length === 0) return Alert.alert('Info', 'Please enter details');
    try {
